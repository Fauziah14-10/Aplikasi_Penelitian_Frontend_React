...
function Penelitian() {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      {/* Form Section */}
      <div className="bg-gradient-to-r from-blue-600 via-blue-600 to-blue-500 text-black p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-2xl font-semibold mb-4">{isEditing ? 'Edit Penelitian' : 'Tambah Penelitian'}</h2>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white shadow-md rounded-lg">
          <thead className="bg-gradient-to-r from-blue-800 via-blue-600 to-blue-500 text-white">
            <tr>
